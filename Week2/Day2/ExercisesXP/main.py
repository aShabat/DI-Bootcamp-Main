...
favorite_book("Practial Guide to Evil")
...
describe_city("Ater", "Dread Empire")
describe_city("Keter")
...
def make_shirt(size="large", text="I love Python"):
    print(f"You got a shirt of size {size} with {text} written on it.")
...
def main():
    ...
    if temp < 0:
        ...
        print("Quite chily! Don't forget your coat.")
    elif temp < 23:
        print("Nice weather.")
    elif temp < 32:
