...
let age: number = 100;
let name_local: string = "Elder";
console.log(`My name is ${name_local} and I'm ${age} years old.`);
...
let id: string | number = 0 || "unindentified";
...
function is_positive(n: number): string {
...
function getAction(user: string): string {
  switch (user) {
    case "admin":
